...
A CLI tool to sync photos, downloads, and recordings from Android phones to your Linux computer via ADB. Supports two phones merging into one photo library with automatic date-based organization.
